...
-   **Settings**:
    -   **Enable R Number format validation**: When enabled, the application will check that the KOMS patient number entered in the live demographics field matches the required format ('R' followed by 7 digits).
